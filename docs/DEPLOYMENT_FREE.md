...
Apply `007_security_hardening.sql` and `008_provider_health_state.sql` to the same Supabase project used by both Vercel and Render before treating a public deployment as production-ready.
