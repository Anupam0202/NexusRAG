...
class ResolutionStatus(StrEnum): VERIFIED="VERIFIED";ASSERTED="ASSERTED";INFERRED="INFERRED";CONTRADICTED="CONTRADICTED";REJECTED="REJECTED"
@dataclass(frozen=True,slots=True)
class TemporalInterval:
    valid_from:datetime|None=None;valid_to:datetime|None=None;recorded_at:datetime|None=None
...
@dataclass(frozen=True,slots=True)
class EvidenceRef:
    source_version_id:str;citation_id:str;content_hash:str
    def __post_init__(self)->None:
