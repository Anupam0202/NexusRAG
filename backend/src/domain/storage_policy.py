...
class DataClass(StrEnum): IRREPLACEABLE="IRREPLACEABLE";RECONSTRUCTIBLE="RECONSTRUCTIBLE";EPHEMERAL="EPHEMERAL"
@dataclass(frozen=True,slots=True)
class RetentionPolicy:
    data_class:DataClass;retain_for:timedelta|None;export_before_delete:bool;requires_deletion_receipt:bool;reconstruction_recipe_required:bool
...
def deletion_allowed(policy:RetentionPolicy,*,workspace_authorized:bool,exported:bool,receipt_destination_available:bool)->bool:
    return workspace_authorized and (not policy.export_before_delete or exported) and (not policy.requires_deletion_receipt or receipt_destination_available)
